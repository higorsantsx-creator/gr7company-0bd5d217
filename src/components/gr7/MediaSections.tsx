              ...
              <div key={i} style={{ aspectRatio: "1 / 1" }}>
                ...
                >
                  <MediaSlot
                    ...
                    className={`absolute inset-0 transition-transform duration-[900ms] ease-out group-hover:scale-110 ${p.bg === "white" ? "object-contain p-0" : "object-cover"}`}
                    label={p.category}
                    bg={p.bg}
                  />
              ...
              >
                ...
                >
                  <MediaSlot
                    ...
                    kind={p.kind}
                    alt={`${p.client} — ${p.category}`}
                    className={`absolute inset-0 transition-transform duration-[900ms] ease-out group-hover:scale-110 ${projects[i]?.bg === "white" ? "object-contain p-0" : "object-cover"}`}
                    label={p.category}
                    bg={projects[i]?.bg}
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/20 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
