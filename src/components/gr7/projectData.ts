...
export const projectDataset: ProjectData[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { label: "Campanha Força", src: campanhaForcaAsset.url, href: "https://www.instagram.com/lagostafitness/p/DPWjQ8-juPV/", aspect: "1/1" },
      { label: "Bastidores Treino", src: bastidoresTreinoAsset.url, href: "https://www.instagram.com/lagostafitness/reel/DbOMi_ERcdt/", aspect: "1/1" },
