...
export interface ProjectData {
  ...
  gallery: { kind?: "image" | "video"; src?: string; label?: string; href?: string }[];
...
export const projectDataset: ProjectData[] = [
  {
    ...
    gallery: [
      ...
      { label: "Atendimento na pista", src: new URL("../../assets/projects/totalgiro/atendimento-02.jpg", import.meta.url).href, href: "https://www.instagram.com/postostotalgiro/reel/DTgct1NDIjU/" },
      ...
      { label: "Loja de conveniência", src: new URL("../../assets/projects/totalgiro/loja-02.jpg", import.meta.url).href, href: "https://www.instagram.com/postostotalgiro/reel/DQ9QSGrAJMO/" },
      { label: "Loja de conveniência", src: new URL("../../assets/projects/totalgiro/loja-03.jpg", import.meta.url).href, href: "https://www.instagram.com/postostotalgiro/reel/Day053TvYQS/" },
    ],
    timeline: [
