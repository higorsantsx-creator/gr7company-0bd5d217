...
export const projectDataset: ProjectData[] = [
  ...
  },
  {
    slug: "bobby-moveis",
    client: "Bobby Móveis",
    category: "Social Media · Branding · Estratégia",
    status: "Em execução",
    clientSince: "2024",
    duration: "Cliente ativo",
    summary:
      "Elevamos o padrão digital da Bobby Móveis através de uma direção criativa sofisticada e uma estratégia de conteúdo que conecta o design de interiores à experiência do consumidor final no Instagram.",
    kpis: [
      { label: "Seguidores", value: 15400 },
      { label: "Alcance", value: 182, prefix: "+", suffix: "%" },
      { label: "Engajamento", value: 6.4, suffix: "%", decimals: 1 },
      { label: "Views (Reels)", value: 420000 },
      { label: "Interações", value: 12500 },
      { label: "Salvos", value: 3200 },
      { label: "Compart.", value: 1800 },
      { label: "CTR", value: 5.2, suffix: "%", decimals: 1 },
    ],
    overallScore: 95,
    scores: [
      { label: "Social Media", value: 96 },
      { label: "Direção Criativa", value: 98 },
      { label: "Branding", value: 94 },
      { label: "Produção", value: 95 },
      { label: "Estratégia", value: 93 },
    ],
    satisfaction: 5,
    growth: [
      { label: "M1", value: 15 },
    ...
    distribution: [
      { label: "Social Media", value: 40, color: "#ff1a1a" },
      { label: "Branding", value: 25, color: "#0a0a0a" },
      { label: "Conteúdo", value: 20, color: "#ff6b6b" },
      { label: "Ads", value: 15, color: "#e5e5e5" },
    ],
    beforeAfter: [
      { label: "Identidade" },
      { label: "Feed" },
    ...
    gallery: [
      { label: "Logotipo Bobby", src: "/__l5e/assets-v1/9855cf35-c692-46ac-8963-14cb90736faf/marketing-capa.png", bg: "white", aspect: "4/3" },
      { label: "Feed Estruturado", src: "", href: "https://www.instagram.com/bobbymoveis/", aspect: "1/1" },
      { label: "Direção Criativa", src: "", aspect: "9/16" },
      { label: "Produção Audiovisual", src: "", aspect: "9/16" },
    ],
    timeline: [
      { title: "Diagnóstico", detail: "Auditoria de posicionamento e concorrência" },
      { title: "Planejamento", detail: "Nova linha editorial e identidade para social" },
      { title: "Direção", detail: "Curadoria visual e padrão estético de luxo" },
      { title: "Execução", detail: "Gestão diária e produção de conteúdo" },
      { title: "Análise", detail: "Monitoramento de métricas e ajuste estratégico" },
    ],
    deliverables: [
    ...
    testimonial: {
      ...
      quote:
        "A GR7 entendeu exatamente o nível de sofisticação que queríamos passar. Nossa marca hoje respira design no digital.",
    },
  },
  {
