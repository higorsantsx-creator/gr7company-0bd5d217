...
export const projectDataset: ProjectData[] = [
  ...
  },
  {
    ...
    duration: "Cliente ativo",
    summary:
      "Gestão 360º para a Shineray, focada em transformar a presença digital da marca em Alagoas. Atuamos desde a direção de arte e branding até campanhas de alta performance, conectando a inovação da mobilidade elétrica com o público local.",
    kpis: [
      { label: "Leads", value: 3420 },
      { label: "Vendas", value: 184, prefix: "+" },
      { label: "Alcance", value: 850000 },
      { label: "Engajamento", value: 124, prefix: "+", suffix: "%" },
      { label: "CPL", value: 14.20, prefix: "R$ ", decimals: 2 },
      { label: "Views", value: 2400000 },
      { label: "Compart.", value: 15200 },
      { label: "ROI", value: 8.4, suffix: "x", decimals: 1 },
    ],
    overallScore: 98,
    scores: [
    ...
    distribution: [
      { label: "Performance", value: 45, color: "#ff1a1a" },
      { label: "Social Media", value: 30, color: "#0a0a0a" },
      { label: "Branding", value: 15, color: "#ff6b6b" },
      { label: "Produção", value: 10, color: "#e5e5e5" },
    ],
    beforeAfter: [
      { label: "Feed" },
      { label: "Stories" },
    ...
    gallery: [
      { label: "Mobilidade Elétrica", src: "" },
      { label: "Showroom", src: "" },
      { label: "Performance", src: "" },
      { label: "Social Media", src: "" },
      { label: "Design", src: "" },
      { label: "Evento", src: "" },
    ],
    timeline: [
      { title: "Onboarding", detail: "Imersão no ecossistema Shineray" },
      { title: "Estratégia", detail: "Plano de mídia e régua de conteúdo" },
      { title: "Branding", detail: "Refino de linguagem visual local" },
      { title: "Performance", detail: "Setup de campanhas Lead Gen" },
      { title: "Social", detail: "Ativação diária multicanal" },
      { title: "Escala", detail: "Otimização de ROAS e volume" },
    ],
    deliverables: [
      "Social Media",
      "Meta Ads",
    ...
    testimonial: {
      name: "Gestão Shineray",
      role: "Diretoria",
      company: "Shineray Alagoas",
      quote:
