...
const architecturalWonders: CardItem[] = [
  ...
  },
  {
    ...
    imgSrc:
      "https://images.unsplash.com/photo-1585329017236-46abbe0f301f?w=900&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    imgSrc:
      "https://images.unsplash.com/photo-1572364769167-198dcb7b520c?w=900&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    imgSrc:
      "https://images.unsplash.com/photo-1564507592333-c60657451dd7?w=900&auto=format&fit=crop&q=60",
...
export default function ExpandingCardsDemo() {
  return (
    <div className="flex w-full flex-col items-center justify-center space-y-12 bg-transparent p-4 md:p-12 relative z-10 overflow-hidden">
      <div className="text-center space-y-4 max-w-3xl">
        <h2 className="text-4xl md:text-5xl font-black tracking-tight text-white uppercase italic">
          <span className="text-[#ff1a1a]">Maravilhas</span> da Estratégia
        </h2>
        <p className="text-lg text-white/60 font-medium">
          Explore as criações mais ambiciosas e impactantes da GR7. Passe o mouse ou
          toque para revelar os detalhes de cada obra-prima.
        </p>
      </div>
      <ExpandingCards items={architecturalWonders} defaultActiveIndex={0} className="border-white/10" />
    </div>
  );
}
